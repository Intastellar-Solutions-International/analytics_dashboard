            ...
            <div className="navOverlay">
                <aside className="sidebar">
                    <nav className="collapsed">
                        ...
                        <Link className={"navItems" + (useLocation().pathname.indexOf("/dashboard") > -1 ? " --active" : "")} to={"/"+JSON.parse(localStorage.getItem("globals")).access.type["gdpr"].uri+"/dashboard"}><i className="dashboard-icons home"></i> <span className="hiddenCollapsed">Home</span></Link>
